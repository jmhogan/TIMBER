...
# X python3 BBTo2b4tau.py full_SIGNAL_2023BPix.txt 0 26 2023BPix

# M400 prompts
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2022M400.txt 0 64 2022
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2022EEM400.txt 0 72 2022EE
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2023M400.txt 0 80 2023
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2023BPixM400.txt 0 26 2023BPix

# M1000 prompts
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2022M1000.txt 0 64 2022
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2022EEM1000.txt 0 72 2022EE
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2023M1000.txt 0 50 2023 
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2023BPixM1000.txt 0 26 2023BPix

# M1600 prompts
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2022M1600.txt 0 64 2022
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2022EEM1600.txt 0 72 2022EE
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2023M1600.txt 0 50 2023 
# python3 BBTo2b4tauKALIN.py full_SIGNAL_2023BPixM1 0 50 2023BPix
...
def analyze(jesvar):
  ...
  recoGenVars.Add('GenList', 'GenList(isSig, nObjects, nbjets, tauArr, bjetArr, vecbArr, nGenPart, GenPart_pdgId, GenPart_pt, GenPart_eta, GenPart_phi, GenPart_mass)') # Topograph thing
  ...
  a.Apply([jCuts, metVars, tVars, tCuts, recoGenVars, manualVars])  #, metCuts, rframeVars
  
  allColumns = a.GetColumnNames()
  columns = ['gcJet_HT','NJets_DeepFlavM','corrMET_pt', 'NisGood', 'decayTypeSum', 'ObjectList_indices', 'matchability', 'nObjects', 'nbjets', 'PtListObject', 'EtaListObject', 'PhiListObject', 'EnergyListObject', 'TaggedListObject', 'pdgIdListGen', 'pdgIdListGen', 'ptListGen', 'etaListGen', 'phiListGen', 'massListGen', 'PtListObject', 'EtaListObject', 'PhiListObject', 'EnergyListObject', 'TaggedListObject', 'B1finalPx', 'B1finalPy', 'B1finalPz', 'B1finalM','B2finalPx', 'B2finalPy', 'B2finalPz','B2finalM' ] 
